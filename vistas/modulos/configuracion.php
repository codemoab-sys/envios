...
<style>
    ...
    [data-theme="light"] .configuracion-page .config-card h2 { color: #2563eb; border-bottom-color: #e5e7eb; }
    [data-theme="light"] .configuracion-page .form-label { color: #374151; }
    [data-theme="light"] .configuracion-page .form-control,
    [data-theme="light"] .configuracion-page .option,
    [data-theme="light"] .configuracion-page .day { background: #f8fafc; border-color: #d6dee8; color: #374151; }
    [data-theme="light"] .configuracion-page .form-control:focus { background: #fff; }
    [data-theme="light"] .configuracion-page .help-text { color: #748196; }
    [data-theme="light"] .configuracion-page .option.selected { background: #e8f0ff; color: #2563eb; }
    [data-theme="light"] .configuracion-page .day:has(input:checked) { color: #fff; }
</style>
